...
import { useActiveWeb3React, useMulticallContract, useBlockNumber } from '../state-hooks'
...
export function MulticallUpdater(): null {
  ...
  const { fetchingMulticallResults, updateMulticallResults, errorFetchingMulticallResults } = useContext(
    Web3StatusActions
  )
